# 🧙‍♂️ Zsh completions for Gleam

Zsh tab completions supporting the entire range of commands that the Gleam CLI has to offer;
with smart completions for files, packages, and modules.
